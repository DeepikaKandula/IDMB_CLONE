    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarColor01">
        ...
        if(isset($_SESSION['mail'])){
          ...
          <button class="btn btn-outline-light me-3" type="submit" id="submit">Search</button>
        </form>';
      }
        ?>
        ...
        <ul class="navbar-nav ">
          ...
          if(!isset($_SESSION['mail'])){
                ...
                <a class="nav-link active" aria-current="page" href="./login.php"><b>Sign In</b></a>
              </li>';
          }
          else{
            echo '<li class="nav-item me-4">
    ...
    <script>
      ...
      search.addEventListener("click",(e)=>{
        ...
        const options = {
	      method: 'GET',
	      headers: {
		    'X-RapidAPI-Key': 'ba5562be2fmsh90368ac52dac270p15c946jsn8f41eae4a81c',
...
fetch(`https://imdb8.p.rapidapi.com/auto-complete?q=${movieName}`, options)
    ...
    for(let i=0;i<movies.length;i++){
      ...
      let hh = movie.s;
      let year = movie.y;
   card =card+`<div class="card mb-3" style="max-width: 540px;margin-right:2rem;">
  <div class="row g-0">
    <div class="col-md-4">
