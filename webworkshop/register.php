...
<body class="bg-light">
    <form action="./msp.php" method="POST" class="p-5 mt-5 bg-dark">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-floating m-3">
                    <input type="text" class="form-control" id="floatingInput gender" name="gender">
            ...
            <div class="col-md-6">
                <button type="submit" class="btn btn-success w-50 d-block m-auto mt-3" name="submit">Register</button>
            </div>
        </div>
    </form>
</body>
